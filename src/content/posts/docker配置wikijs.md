...
![安装插件](../../assets/images/wikijs/安装插件.png)


![Node.js安装版本](../../assets/images/wikijs/安装插件_postgresql.png)
![Node.js安装版本](../../assets/images/wikijs/安装插件_nodejs.png)

下载[wiki.js](https://github.com/requarks/wiki/releases/)后在```/www/wwwroot```下解压

<!-- ![解压后看起来长这样](../../assets/images/wikijs/) -->

![配置数据库](../../assets/images/wikijs/配置数据库.png)
![配置数据库](../../assets/images/wikijs/配置数据库_2.png)

![配置插件_nginx](../../assets/images/wikijs/配置插件_nginx.png)
![配置网站_node](../../assets/images/wikijs/配置网站_node.png)
![配置网站文件](../../assets/images/wikijs/配置网站文件.png)
![配置网站配置文件](../../assets/images/wikijs/配置网站配置文件.png)
![配置网站离线](../../assets/images/wikijs/配置网站离线.png)
